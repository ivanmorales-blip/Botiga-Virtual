...
<div x-data="{ open: true }" class="layout">

    <!-- HEADER -->
    <header class="header header--admin">
        <div class="header__left">
            <span class="header__title">SERRELLERIA SOLIDÀRIA</span>
        </div>
    ...
    <div class="layout__body">
        ...
        <!-- SIDEBAR -->
        <aside :class="open ? 'sidebar sidebar--open' : 'sidebar sidebar--closed'">

            <!-- TOGGLE BUTTON -->
            <button @click="open = !open" class="sidebar__toggle">
                ☰
            </button>

            <!-- LOGO -->
            <div class="sidebar__logo">
                <img src="/images/logoserralleria.png" alt="Logo">
            </div>
            ...
            <nav class="sidebar__nav">
                ...
                <a href="{{ route('products.react.list') }}" class="sidebar__link">
                    <span class="sidebar__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                    ...
                    <span class="sidebar__text">Productes</span>
                </a>

                <a href="{{ route('categorias.react.list') }}" class="sidebar__link">
                    <span class="sidebar__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                ...
                <a href="{{ route('caracteristicas.react.list') }}" class="sidebar__link">
                    <span class="sidebar__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                    ...
                    <span class="sidebar__text">Característiques</span>
                </a>

                <a href="{{ route('packs.react.list') }}" class="sidebar__link">
                    <span class="sidebar__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
...
<a href="{{ route('pedidos.index') }}" class="sidebar__link">
    ...
    <span class="sidebar__text">Gestionar Pedidos</span>
</a>

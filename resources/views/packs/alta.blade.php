        ...
        <form id="pack-form" action="{{ route('packs.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                ...
                <div>
                    ...
                    <input type="text" name="nom" required value="{{ old('nom') }}" class="w-full border border-gray-300 rounded-xl px-4 py-2 focus:ring-2 focus:ring-gray-400 focus:outline-none">
                </div>
                    ...
                    >
                        ...
                        @foreach($products as $product)
                            ...
                            >
                                ...
                                <div class="text-gray-300 text-xl select-none">
                                    ☰
                                </div>
